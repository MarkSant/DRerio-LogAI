...
class TestVideoTreeRefreshEventEdgeCases:
    ...
    def test_unsubscribe_stops_receiving_events(self):
        ...
        event_bus.publish(Event(type=UIEvents.VIDEO_TREE_REFRESH_REQUESTED, data={'filter_text': 'test1'}))

        # Unsubscribe
        event_bus.unsubscribe(UIEvents.VIDEO_TREE_REFRESH_REQUESTED, handler)

        # Publish after unsubscribe
        event_bus.publish(Event(type=UIEvents.VIDEO_TREE_REFRESH_REQUESTED, data={'filter_text': 'test2'}))
