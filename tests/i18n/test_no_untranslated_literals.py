...
MIGRATED_PATHS: tuple[str, ...] = (
    ...
    "src/zebtrack/ui/components/analysis_controls.py",
    "src/zebtrack/ui/components/analysis_display.py",
    "src/zebtrack/ui/components/analysis_profile.py",
    "src/zebtrack/ui/components/analysis_view_controller.py",
    "src/zebtrack/ui/components/arduino_bindings_panel.py",
    "src/zebtrack/ui/components/behavioral_config_widget.py",
    "src/zebtrack/ui/components/arduino_dashboard.py",
    "src/zebtrack/ui/components/canvas/event_handler.py",
    "src/zebtrack/ui/components/canvas/multi_aquarium_overlay.py",
    "src/zebtrack/ui/components/canvas/renderer.py",
    "src/zebtrack/ui/components/canvas/video_frame_manager.py",
    "src/zebtrack/ui/components/canvas/zone_editor.py",
    "src/zebtrack/ui/components/config_editor.py",
    "src/zebtrack/ui/components/control_panel.py",
    "src/zebtrack/ui/components/dialog_manager.py",
    ...
    "src/zebtrack/ui/components/polygon_drawing_service.py",
    "src/zebtrack/ui/components/project_model_configuration_panel.py",
    "src/zebtrack/ui/components/project_views",
    "src/zebtrack/ui/components/roi_template_manager.py",
    "src/zebtrack/ui/components/state_synchronizer.py",
    "src/zebtrack/ui/components/tab_builder.py",
    "src/zebtrack/ui/components/validation_manager.py",
    "src/zebtrack/ui/components/validators",
    "src/zebtrack/ui/components/weight_hardware_manager.py",
    "src/zebtrack/ui/components/zone_context_panel.py",
    "src/zebtrack/ui/components/zone_edit_guard.py",
