...
MIGRATED_PATHS: tuple[str, ...] = (
    "src/zebtrack/coordinators/dialog_coordinator.py",
    "src/zebtrack/coordinators/live_camera_session_coordinator.py",
