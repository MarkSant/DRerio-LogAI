...
def test_single_video_config_dialog_has_interval_methods():
    """Test that SingleVideoConfigDialog has the expected interval-related methods and attributes."""
    ...
    with patch('zebtrack.ui.gui.settings'), \
        ...
        # The dialog should create analysis_interval_var and display_interval_var with value "10"
        # Since we mocked StringVar, we just check that the attributes exist
...
def test_create_project_dialog_has_interval_methods():
    """Test that CreateProjectDialog has the expected interval-related methods and attributes."""
...
def test_project_manager_create_new_project_signature():
    """Test that ProjectManager.create_new_project accepts interval frame parameters."""
