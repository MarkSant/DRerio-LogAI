...
def test_zone_controls_has_fixed_button_frame():
    ...
    try:
        ...
        assert hasattr(widget, "fixed_button_frame"), (
            "ZoneControlsWidget must have fixed_button_frame"
        )
        assert isinstance(widget.fixed_button_frame, tk.Widget), (
            "fixed_button_frame must be a widget"
        )
