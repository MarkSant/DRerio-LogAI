...
def test_detect_aquariums_strict_threshold(mock_yolo, mock_frame, mock_yolo_result_15_percent):
    ...
    with patch("zebtrack.core.aquarium_detector.VideoFileSource") as MockVideoSource:
        ...
        # Should fail (return empty or default, depending on fallback, but here we expect
        # handled empty list from filtering, then consensus fail or default)
        ...
        # The 15% polygon has width 15. The default one has margin 10% -> 10,10 to 90,90
        # -> width 80.
