...
def test_interactive_buttons_positioned_after_zone_list():
    ...
    assert 'Positioned right after zone list' in zone_controls_section or \
           'right after zone list' in zone_controls_section.lower(), \
...
def test_interactive_buttons_not_packed_initially():
    ...
    buttons_section = zone_controls_section.split(
        'self.interactive_buttons_frame = ttk.Frame'
    )[1]
