...
def test_arduino_manager_is_connected_when_connected(mock_controller, arduino_factory, mock_arduino):
...
def test_arduino_manager_is_connected_when_port_closed(mock_controller, arduino_factory, mock_arduino):
