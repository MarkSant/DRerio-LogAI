...
def test_single_video_with_zones_shows_all_flags(mock_wm, mock_gui):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert video_entry["status"] == "processed", f"Status should be 'processed', got {video_entry['status']}"
        ...
        retrieved_zone_data = controller.project_manager.get_zone_data(video_path, fallback_to_global=False)
