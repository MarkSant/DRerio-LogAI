...
class ControlPanelWidget(BaseWidget):
    ...
    def _build_ui(self) -> None:
        ...
        interval_entry = ttk.Entry(
            interval_frame,
            textvariable=self.processing_interval_var,
            width=10
        )
    ...
    def _on_preview_toggled(self) -> None:
        ...
        self.emit_event("control.preview_toggled", {
    ...
    def _on_interval_changed(self, event=None) -> None:
        ...
        try:
            ...
            self.emit_event("control.interval_changed", {
                "interval": interval
            })
        except ValueError:
            self._log.warning("control_panel.invalid_interval",
