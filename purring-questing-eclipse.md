...
4. `recording_session_orchestrator.py` (757 linhas) → SessionCoordinator
5. `project_orchestrator.py` (526 linhas) → ProjectLifecycleCoordinator

**Semana 8 (Risco: MÉDIO):**
6. `ui_state_controller.py` (626 linhas) → **ESPECIAL** - mesclar com Phase 4 UIStateController
7. `model_diagnostics_orchestrator.py` (608 linhas) → HardwareCoordinator ou novo service
